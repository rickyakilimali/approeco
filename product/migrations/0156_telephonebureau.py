# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-02-08 12:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marque', models.CharField(choices=[('ABB', 'ABB'), ('GENERAL ELECTRIC', 'GENERAL ELECTRIC'), ('SCHNEIDER', 'SCHNEIDER'), ('SUPREMA', 'SUPREMA'), ('PROLINE', 'PROLINE'), ('TELEMECA', 'TELEMECA')], max_length=100, verbose_name='MARQUE TELEPHONE')),
                ('interface', models.CharField(choices=[('ETHERNET', 'ETHERNET')], max_length=100, verbose_name='INTERFACE')),
