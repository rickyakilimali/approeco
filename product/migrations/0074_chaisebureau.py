# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-31 11:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0073_chaisesalleattente'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_chaise', models.CharField(choices=[('CHAISE ORDINATEUR', 'CHAISE ORDINATEUR'), ('CHAISE DE BUREAU', 'CHAISE DE BUREAU'), ('CHAISE VISITEUR', 'CHAISE VISITEUR'), ('CHAISE DE DIRECTION', 'CHAISE DE DIRECTION')], max_length=20, verbose_name='TYPE DE CHAISE')),
                ('revetement', models.CharField(choices=[('MAILLE', 'MAILLE'), ('CUIR', 'CUIR'), ('TISSU ET MAILLE', 'TISSU ET MAILLE')], max_length=20, verbose_name='REVETEMENT')),
