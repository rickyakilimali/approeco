...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0128_auto_20180201_1800'),
    ]

    operations = [
        migrations.CreateModel(
            name='MinuteurContacteur',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250)),
                ('is_active', models.BooleanField()),
                ('type_temporisation', models.CharField(choices=[('REPOS', 'REPOS'), ('TRAVAIL', 'TRAVAIL')], max_length=100, verbose_name='TYPE DE TEMPORISATION')),
                ('domaine_reglage', models.CharField(choices=[('0.1..3S', '0.1..3S'), ('0.1..30S', '0.1..30S'), ('10..180S', '10..180S')], max_length=100, verbose_name='DOMAINE DE REGLAGE(SECONDES)')),
