# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-31 15:01
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0088_locationcamion'),
    ]

    operations = [
        migrations.CreateModel(
            name='LocationRemorqueMatadi',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250)),
                ('is_active', models.BooleanField()),
                ('nombre_pied', models.CharField(choices=[('20', '20'), ('40', '40'), ('2x20', '2x20')], max_length=100, verbose_name='NOMBRE DE PIED')),
