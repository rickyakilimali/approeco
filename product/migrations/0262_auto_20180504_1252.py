# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-04 12:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_treillis', models.CharField(choices=[('MAISON', 'MAISON'), ('MAILLE CARRE GRAND', 'MAILLE CARRE GRAND'), ('MAILLE CARRE PETIT', 'MAILLE CARRE PETIT'), ('MAILLE HEXAGONALE', 'MAILLE HEXAGONALE'), ('CARRE FERME', 'CARRE FERME')], max_length=100, verbose_name='TYPE DE TREILLIS')),
                ('dimension_metre_x_metre', models.CharField(choices=[('1Mx25M', '1Mx25M'), ('2Mx25M', '2Mx25M')], max_length=100, verbose_name='DIMENSION (m x m)')),
        ...
        migrations.AlterField(
            ...
            name='dimension',
            field=models.CharField(choices=[('1Mx25M', '1Mx25M'), ('2Mx25M', '2Mx25M')], max_length=20, verbose_name='DIMENSION(MILLIMETRES)'),
        ),
        migrations.AlterField(
            model_name='rivet',
            name='dimension_en_mm',
            field=models.CharField(choices=[('1Mx25M', '1Mx25M'), ('2Mx25M', '2Mx25M')], max_length=100, verbose_name='DIMENSION (en mm)'),
        ),
    ]
