# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-11 10:39
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0310_auto_20180511_1001'),
    ]

    operations = [
        migrations.CreateModel(
            name='CoursLangueNationale',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250, verbose_name='PRODUIT')),
                ('is_active', models.BooleanField()),
                ('langue_cours', models.CharField(choices=[('LINGALA', 'LINGALA'), ('KIKONGO', 'KIKONGO'), ('SWAHILI', 'SWAHILI'), ('TSHILUBA', 'TSHILUBA')], max_length=20, verbose_name='LANGUE')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nom', models.CharField(max_length=250, verbose_name='PRODUIT')),
                ('is_active', models.BooleanField()),
                ('type_fil_barbele', models.CharField(choices=[('PIQUANT', 'PIQUANT'), ('COUPANT', 'COUPANT')], max_length=100, verbose_name='DIMENSION')),
        ...
        migrations.RenameModel(
            old_name='CoursLangue',
            new_name='CoursLangueEtrangere',
        ),
    ]
