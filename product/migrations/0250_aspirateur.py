# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-03 14:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puissance', models.CharField(choices=[('1250W', '1250W'), ('2250W', '2250W'), ('2600W', '2600W'), ('700W', '700W')], max_length=100, verbose_name='PUISSANCE (WATT)')),
                ('type_aspirateur', models.CharField(choices=[('ASPIRATEUR EAU ET POUSSIERE', 'ASPIRATEUR EAU ET POUSSIERE'), ('ASPIRATEUR A CENDRE', 'ASPIRATEUR A CENDRE')], max_length=100, verbose_name="TYPE D'ASPIRATEUR")),
                ('capacite_reservoir', models.CharField(choices=[('12L', '12L'), ('30L', '30L'), ('25L', '25L'), ('25L', '25L')], max_length=100, verbose_name='CAPACITE RESERVOIR(LITRE)')),
