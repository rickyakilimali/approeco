# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-23 14:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0395_clavieretsourissansfil_claviersansfil'),
    ]

    operations = [
        migrations.CreateModel(
            name='EnsemblePoidsMuscul',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250, verbose_name='PRODUIT')),
                ('is_active', models.BooleanField()),
                ('poids', models.CharField(choices=[('50KG', '50KG')], max_length=100, verbose_name='POIDS EN KILOGRAMME')),
