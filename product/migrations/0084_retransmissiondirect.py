# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-31 13:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0083_presencephysiquesurplateau'),
    ]

    operations = [
        migrations.CreateModel(
            name='RetransmissionDirect',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250)),
                ('is_active', models.BooleanField()),
                ('duree_retransmission', models.CharField(choices=[('1 HEURE', '1 HEURE'), ('3 HEURES', '3 HEURES')], max_length=100, verbose_name='DUREE RETRANSMISSION')),
