# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-31 14:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0087_missioncontrolechantier'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tonnage', models.CharField(choices=[('20T', '20T')], max_length=100, verbose_name='TONNAGE')),
                ('zone', models.CharField(choices=[('INTRA-URBAIN', 'INTRA-URBAIN')], max_length=100, verbose_name='ZONE')),
