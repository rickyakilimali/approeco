# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-04 09:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0252_reproductioncle'),
    ]

    operations = [
        migrations.CreateModel(
            name='SonnerieElectrique',
            fields=[
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('ANGLAIS-FRANCAIS', 'ANGLAIS-FRANCAIS'), ('FRANCAIS-LINGALA', 'FRANCAIS-LINGALA'), ('ANGLAIS-LINGALA', 'ANGLAIS-LINGALA'), ('PORTUGAIS-FRANCAIS', 'PORTUGAIS-FRANCAIS'), ('FRANCAIS-TSHILUBA', 'FRANCAIS-TSHILUBA'), ('ALLEMAND-FRANCAIS', 'ALLEMAND-FRANCAIS'), ('ESPAGNOL-FRANCAIS', 'ESPAGNOL-FRANCAIS'), ('SWAHILI-FRANCAIS', 'SWAHILI-FRANCAIS'), ('LINGALA-FRANCAIS', 'LINGALA-FRANCAIS'), ('KIKONGO-FRANCAIS', 'KIKONGO-FRANCAIS'), ('TSHILUBA-FRANCAIS', 'TSHILUBA-FRANCAIS')], max_length=20, verbose_name='LANGUE'),
        ),
        migrations.AlterField(
            model_name='servicedetraduction',
            name='langue',
            field=models.CharField(choices=[('ANGLAIS-FRANCAIS', 'ANGLAIS-FRANCAIS'), ('FRANCAIS-LINGALA', 'FRANCAIS-LINGALA'), ('ANGLAIS-LINGALA', 'ANGLAIS-LINGALA'), ('ALLEMAND-FRANCAIS', 'ALLEMAND-FRANCAIS'), ('PORTUGAIS-FRANCAIS', 'PORTUGAIS-FRANCAIS'), ('ESPAGNOL-FRANCAIS', 'ESPAGNOL-FRANCAIS'), ('SWAHILI-FRANCAIS', 'SWAHILI-FRANCAIS'), ('LINGALA-FRANCAIS', 'LINGALA-FRANCAIS'), ('KIKONGO-FRANCAIS', 'KIKONGO-FRANCAIS'), ('TSHILUBA-FRANCAIS', 'TSHILUBA-FRANCAIS')], max_length=20, verbose_name='LANGUE'),
        ),
    ]
