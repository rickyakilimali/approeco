# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-31 13:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0079_affichagelogosurecran'),
    ]

    operations = [
        migrations.CreateModel(
            name='ReportageTelepromo',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250)),
                ('is_active', models.BooleanField()),
                ('type_telepromo', models.CharField(choices=[('REPORTAGE DANS JOURNAL TELEVISE', 'REPORTAGE DANS JOURNAL TELEVISE'), ('INVITE DU JOURNAL TELEVISE', 'INVITE DU JOURNAL TELEVISE')], max_length=100, verbose_name='TYPE TELE PROMO')),
