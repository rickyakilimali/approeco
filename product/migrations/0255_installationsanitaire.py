# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-04 10:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='InstallationSanitaire',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250, verbose_name='PRODUIT')),
                ('is_active', models.BooleanField()),
                ('type_sanitaire', models.CharField(choices=[('LAVABO COMPLET', 'LAVABO COMPLET'), ('LAVE MAIN COMPLET', 'LAVE MAIN COMPLET'), ('MENAGERE', 'MENAGERE')], max_length=100, verbose_name="TYPE D'INSTALLATION SANITAIRE")),
