# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-03 16:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0251_machineagricole'),
    ]

    operations = [
        migrations.CreateModel(
            name='ReproductionCle',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250, verbose_name='PRODUIT')),
                ('is_active', models.BooleanField()),
                ('type_de_reproduction', models.CharField(choices=[('DOUBLURE CLE SIMPLE', 'DOUBLURE CLE SIMPLE'), ('DOUBLURE CONTACT VEHICULE', 'DOUBLURE CONTACT VEHICULE'), ('REPRODUCTION CLE MEMOIRE VEHICULE', 'REPRODUCTION CLE MEMOIRE VEHICULE')], max_length=100, verbose_name='TYPE DE REPRODUCTION')),
