...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0081_pagemagazine'),
    ]

    operations = [
        migrations.CreateModel(
            name='PubliciteSurPlateau',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250)),
                ('is_active', models.BooleanField()),
                ('type_publicite', models.CharField(choices=[('DECORATION PLATEAU', 'DECORATION PLATEAU'), ('PRODUIT SUR PLATEAU', 'PRODUIT SUR PLATEAU')], max_length=100, verbose_name='TYPE DE PUBLICITE')),
