# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-11 09:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0308_fixationtv_vismetallique'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('ANGLAIS-FRANCAIS', 'ANGLAIS-FRANCAIS'), ('ANGLAIS-LINGALA', 'ANGLAIS-LINGALA'), ('PORTUGAIS-FRANCAIS', 'PORTUGAIS-FRANCAIS'), ('FRANCAIS-TSHILUBA', 'FRANCAIS-TSHILUBA'), ('ALLEMAND-FRANCAIS', 'ALLEMAND-FRANCAIS'), ('ESPAGNOL-FRANCAIS', 'ESPAGNOL-FRANCAIS'), ('SWAHILI-FRANCAIS', 'SWAHILI-FRANCAIS'), ('SWAHILI-ANGLAIS', 'SWAHILI-ANGLAIS'), ('LINGALA-FRANCAIS', 'LINGALA-FRANCAIS'), ('LINGALA-ANGLAIS', 'LINGALA-ANGLAIS'), ('KIKONGO-FRANCAIS', 'KIKONGO-FRANCAIS'), ('KIKONGO-ANGLAIS', 'KIKONGO-ANGLAIS'), ('TSHILUBA-FRANCAIS', 'TSHILUBA-FRANCAIS'), ('TSHILUBA-ANGLAIS', 'TSHILUBA-ANGLAIS')], max_length=20, verbose_name='LANGUE'),
        ),
    ]
