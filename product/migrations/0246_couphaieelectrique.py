# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-03 11:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0245_auto_20180503_1129'),
    ]

    operations = [
        migrations.CreateModel(
            name='CoupHaieElectrique',
            fields=[
                ...
                ('puissance', models.CharField(choices=[('900W', '900W')], max_length=100, verbose_name='PUISSANCE (WATT)')),
                ('longueur_de_coupe', models.CharField(choices=[('60CM', '60CM')], max_length=100, verbose_name='LONGUEUR DE COUPE (CENTIMETRE)')),
