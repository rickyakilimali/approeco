# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-04 10:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dimension_en_mm', models.CharField(choices=[('4x40 MM', '4x40 MM'), ('4x25 MM', '4x25 MM')], max_length=100, verbose_name='DIMENSION (en mm)')),
        ...
        migrations.AlterField(
            model_name='wc',
            name='marque',
            field=models.CharField(choices=[('ARISTON ', 'ARISTON '), ('PARADISE ', 'PARADISE ')], max_length=100, verbose_name='MARQUE'),
        ),
    ]
