# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-31 12:25
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0074_chaisebureau'),
    ]

    operations = [
        migrations.CreateModel(
            name='DiffusionSpotPublicitaire',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250)),
                ('is_active', models.BooleanField()),
                ('periode', models.CharField(choices=[('AVANT 18H', 'AVANT 18H'), ('APRES 18H', 'APRES 18H'), ('PENDANT UNE EMISSION PHARE', 'PENDANT UNE EMISSION PHARE')], max_length=100, verbose_name='PERIODE')),
