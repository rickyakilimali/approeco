# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-03 13:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0246_couphaieelectrique'),
    ]

    operations = [
        migrations.CreateModel(
            name='DecapeuThermique',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250, verbose_name='PRODUIT')),
                ('is_active', models.BooleanField()),
                ('marque', models.CharField(choices=[('DEWALT', 'DEWALT')], max_length=100, verbose_name='MARQUE')),
                ('puissance', models.CharField(choices=[('1800W', '1800W')], max_length=100, verbose_name='PUISSANCE (WATT)')),
