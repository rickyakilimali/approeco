# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-04 14:29
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0269_arracheclou_diable'),
    ]

    operations = [
        migrations.CreateModel(
            name='AttacheCableAClouer',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250, verbose_name='PRODUIT')),
                ('is_active', models.BooleanField()),
                ('dimension_attache_mm', models.CharField(choices=[('25', '25'), ('20', '20'), ('16', '16'), ('10', '10'), ('8', '8'), ('6', '6')], max_length=100, verbose_name='DIMENSION ATTACHE EN MM')),
