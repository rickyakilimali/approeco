# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-04 09:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0253_auto_20180504_0929'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_wc', models.CharField(choices=[('MONOBLOC', 'MONOBLOC')], max_length=100, verbose_name='TYPE DE WC')),
                ('marque', models.CharField(choices=[('ARISTON ', 'ARISTON '), ('PARADISE ', 'PARADISE ')], max_length=100, verbose_name='marque')),
