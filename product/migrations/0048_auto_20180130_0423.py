# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-30 04:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0047_auto_20180130_0406'),
    ]

    operations = [
        migrations.CreateModel(
            name='ConceptionPageMagazine',
            fields=[
        ...
        migrations.AddField(
            model_name='buffet',
            name='sur_place',
            field=models.CharField(blank=True, choices=[('OUI', 'OUI'), ('NON', 'NON')], max_length=20, null=True, verbose_name='SUR PLACE'),
        ),
        migrations.AddField(
