# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-05-23 14:56
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0396_ensemblepoidsmuscul'),
    ]

    operations = [
        migrations.CreateModel(
            name='ImprimantePhoto',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=250, verbose_name='PRODUIT')),
                ('is_active', models.BooleanField()),
                ('marque_imprimante', models.CharField(choices=[('CANON', 'CANON')], max_length=100, verbose_name="MARQUE DE L'IMPRIMANTE")),
                ('modele_imprimante', models.CharField(choices=[('SELPHY CP190', 'SELPHY CP190')], max_length=100, verbose_name="MODELE DE L'IMPRIMANTE")),
