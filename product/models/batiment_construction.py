...
class Peinture(productbase.ProductBase):
	...
	composition =models.CharField("COMPOSITION", max_length=20, choices= COMPOSITION_PEINTURE)
	teinte =models.CharField("TEINTE", max_length=20, choices= TEINTE_PEINTURE)
	prix = models.DecimalField("PRIX", max_digits=5, decimal_places=2)
	units = models.CharField("UNITE",max_length=50, choices=UNITE_USD_KG_LITRE)
...
class PeintureSpeciale(productbase.ProductBase):
	type_produit=models.CharField(" TYPE DE PRODUIT", max_length=50, choices= PEINTURE_SPECIALE)
	domaine_application=models.CharField("DOMAINE D'APPLICATION", max_length=50, choices= DOMAINE_APPLICATION)
	caracteristique=models.CharField("CARACTERISTIQUE", max_length=20, choices= CARACTERISTIQUE_PEINTURE)
	prix = models.DecimalField("PRIX", max_digits=5, decimal_places=2)
	units = models.CharField("UNITE",max_length=50, choices=UNITE_USD_KG_LITRE)
#ordonner les produits
	class Meta:
...
class LocationDepot(productbase.ProductBase):
	...
	avenue  = models.CharField("AVENUE",max_length=100, choices=AVENUE_DEPOT)
	commune  = models.CharField("COMMUNE",max_length=100, choices=COMMUNE_DEPOT)
	surface  = models.CharField("SURFACE",max_length=100, choices=SURFACE_DEPOT)
...
class LocationStand(productbase.ProductBase):
	...
	#les attributs
	surface_stand  = models.CharField("SURFACE EN M2",max_length=100, choices=SURFACE_STAND)
...
class Moellon(productbase.ProductBase):
	...
	#les attributs
	type_moellon = models.CharField("TYPE DE MOELLON",max_length=100, choices=TYPE_MOELLON)
	prix = models.DecimalField("PRIX",max_digits=10, decimal_places=2)
	units = models.CharField("UNITE",max_length=50, choices=UNITE_USD_TONE)
...
class LocationCamion(productbase.ProductBase):
	...
	#les attributs
	tonnage = models.CharField("TONNAGE",max_length=100, choices=TONNAGE_CAMION)
	zone = models.CharField("ZONE",max_length=100, choices=ZONE_LOCATION)
...
class ConstructionRoute(productbase.ProductBase):
	...
	matiere=models.CharField("MATIERE", max_length=50, choices= MATIERE_ROUTE)
	canalisation_d_eau=models.CharField("CANALISATION D'EAU", max_length=50, choices= CANALISATION_EAU)
	prix = models.DecimalField("PRIX", max_digits=10, decimal_places=2)
	units = models.CharField("UNITE",max_length=50, choices=UNITE_USD_KM)
#ordonner les produits
	class Meta:
		ordering = ['prix']
#=====================================================
...
class Chambre(productbase.ProductBase):
	nombre_etoile =models.CharField("NOMBRE D'ETOILE", max_length=20, choices= NOMBRE_ETOILE)
	...
	avenue =models.CharField("AVENUE", max_length=20, choices= AVENUE_CHAMBRE)
	commune =models.CharField("COMMUNE", max_length=20, choices= COMMUNE_CHAMBRE)
	prix = models.DecimalField("PRIX", max_digits=5, decimal_places=2)
	units = models.CharField("UNITE",max_length=50, choices=UNITE)
	#ordonner les produits
	class Meta:
...
class Triplex(productbase.ProductBase):
	...
	epaisseur= models.CharField("EPAISSEUR",max_length=100, choices=EPAISSEUR_TRIPLEX)
	prix = models.DecimalField("PRIX",max_digits=10, decimal_places=2)
